...
class QueryParameters {
	public QueryParameters(SubFileParameter subFileParameter, Tile tile, byte _queryZoomLevel) {
		this.queryZoomLevel = _queryZoomLevel;
		calculateBaseTiles(this, tile, subFileParameter);
		calculateBlocks(this, subFileParameter);
	}
	...
	private static void calculateBaseTiles(QueryParameters queryParameters, Tile tile, SubFileParameter subFileParameter) {
	...
	private static void calculateBlocks(QueryParameters queryParameters, SubFileParameter subFileParameter) {
